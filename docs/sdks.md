# SDKs — Clientes para Otros Lenguajes
...
|----------|---------|-----------|--------|
| **Java** | `dev.iskra:iskra-client` | [`sdks/java/iskra-client`](../sdks/java/iskra-client/) | v0.1.0 |
| **Python** | `iskra-client` | [`sdks/python/iskra-client`](../sdks/python/iskra-client/) | v0.1.0 |
...
Documentacion completa: [`sdks/java/iskra-client/README.md`](../sdks/java/iskra-client/README.md)
...
Documentacion completa: [`sdks/python/iskra-client/README.md`](../sdks/python/iskra-client/README.md)
...
Consulta [Process Kit](./process-kit.md) para la integracion via procesos y la plantilla `python-data-processor` para un ejemplo completo.
