 ...
 */
export async function createStorageAdapter(config: StorageConfig): Promise<BaseStorageAdapter> {
    ...
    throw new Error(`Adaptador de almacenamiento no soportado: "${config.adapter}". Usa "local", "s3" o "minio".`);
}
