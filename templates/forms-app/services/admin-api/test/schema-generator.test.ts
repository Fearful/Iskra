...
describe('generateJsonSchema', () => {
    ...
    it('builds an email property with format and a default format message', () => {
        const schema = generateJsonSchema([{ fieldType: 'email', name: 'e', label: 'Email', required: true }]);
    ...
    it('builds a boolean for a single checkbox and an array for a multi checkbox', () => {
        const single = generateJsonSchema([{ fieldType: 'checkbox', name: 'agree', label: 'Agree', required: true }]);
    ...
    it('builds a date property with format', () => {
        const schema = generateJsonSchema([{ fieldType: 'date', name: 'd', label: 'D', required: false }]);
