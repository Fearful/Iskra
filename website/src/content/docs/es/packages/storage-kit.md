...
`PutOptions.public` esta obsoleta y ningun adaptador la usa: para que los objetos
sean publicos, usa una politica del bucket (S3/MinIO) o sirvelos desde tu app (local).
