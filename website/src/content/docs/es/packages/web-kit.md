...
- Con `store: 'db'`, un error de la base al leer, escribir o borrar una sesion hace fallar la request (500, y no se envia cookie). Antes solo se logueaba: el cliente recibia una cookie de una sesion que nunca se guardo, y un logout fallido parecia exitoso.
